			...
			<ol class="property-list asset">
				...
				<li class="fieldcontain">
					<span id="assetClass-label" class="property-label"><g:message code="asset.assetClass.label" default="Asset Class" /></span>
						...
						<span class="property-value" aria-labelledby="assetClass-label"><g:link controller="assetClass" action="show" id="${assetInstance?.assetClass?.id}">${assetInstance?.assetClass?.encodeAsHTML()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="location-label" class="property-label"><g:message code="asset.location.label" default="Location" /></span>
						...
						<span class="property-value" aria-labelledby="location-label"><g:link controller="location" action="show" id="${assetInstance?.location?.id}">${assetInstance?.location?.encodeAsHTML()}</g:link></span>
