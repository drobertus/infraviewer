...
<body>
    ...
    <div class="nav" role="navigation">
        ...
        <ol class="property-list report">
            ...
            <g:if test="${reportInstance?.scheduledRunDate}">
                <li class="fieldcontain">
                    <span id="scheduledRunDate-label" class="property-label"><g:message code="report.scheduledRunDate.label" default="Scheduled Run Date" /></span>
                    <span class="property-value" aria-labelledby="scheduledRunDate-label"><g:formatDate format="yyyy-MM-dd" date="${reportInstance?.scheduledRunDate}" /></span>
                </li>
            </g:if>
