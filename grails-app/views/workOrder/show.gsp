    ...
    <body>
        ...
        <div class="nav" role="navigation">
            ...
            <ol class="property-list workOrder">
                ...
                <g:if test="${workOrderInstance?.status}">
                    <li class="fieldcontain">
                        <span id="status-label" class="property-label"><g:message code="workOrder.status.label" default="Status" /></span>

                        <span class="property-value" aria-labelledby="status-label"><g:fieldValue bean="${workOrderInstance}" field="status"/></span>
                ...
                <g:if test="${workOrderInstance?.reportedDate}">
                    <li class="fieldcontain">
                        ...
                        <span class="property-value" aria-labelledby="reportedDate-label"><g:formatDate format="yyyy-MM-dd" date="${workOrderInstance?.reportedDate}" /></span>
                ...
                <g:if test="${workOrderInstance?.scheduledWorkDate}">
                    <li class="fieldcontain">
                        ...
                        <span class="property-value" aria-labelledby="scheduledWorkDate-label"><g:formatDate format="yyyy-MM-dd" date="${workOrderInstance?.scheduledWorkDate}" /></span>

                    </li>
                </g:if>
                
                <g:if test="${workOrderInstance?.assetClass}">
                    <li class="fieldcontain">
                        <span id="assetClass-label" class="property-label"><g:message code="workOrder.assetClass.label" default="Asset Class" /></span>

                        <span class="property-value" aria-labelledby="assetClass-label"><g:link controller="assetClass" action="show" id="${workOrderInstance?.assetClass?.id}">${workOrderInstance?.assetClass?.name}</g:link></span>

                    </li>
                </g:if>    
                    
                <g:if test="${AssetStatusEventType.Installation.equals(workOrderInstance?.workType)}">
                ...
                <g:if test="${WorkOrderStatusType.Completed.name().equals(workOrderInstance.status)}">
